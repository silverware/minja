...
module.exports =
  ...
  info:
    ...
    stopTimeKnown: "Ende bekannt?"
    deleteStopTime: "Ende löschen"
  ...
  settings:
    ...
    uploadLogoInfo: "Um eine ansprechende Darstellung des Logos zu erreichen, empfehlen wir den Hintergrund transparent zu gestalten."
