    ...
    <fieldset>
      ...
      <div id="logocontainer" {{bind-attr class="tournament.settings.hasLogo::hide"}}>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <img id="logo" style="max-width:100px" src="/{{unbound tournament.identifier}}/logo/display" alt="your tournament logo" />
          </div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          ...
          {{#if tournament.settings.hasLogo}}
            <button class="btn btn-inverse" name="delete" value="1" type="submit" style="margin-right: 20px">{{i18n.settings.deleteLogo}}</button>
          {{/if}}
        </div>
      </div>
    </form>
